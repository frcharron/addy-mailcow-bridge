...
def create_alias(destination_email):
    ...
    return jsonify({"data": {"id": local, "user_id": id,"local_part": local,"email": alias, "active": True,"description": description,"created_at": created,"updated_at": created,"domain": domain}}), 201
